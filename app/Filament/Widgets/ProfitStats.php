    ...
    private function calculatecurrentYearTax($currentDate)
    {
        ...
        return
            Stat::make(
                ...
                Cache::remember('calculatecurrentDate'.auth()->user()->id, Carbon::now()->endOfDay()->subMinute(5), function () use ($taxService, $currentDate) {
    ...
    private function calculateCurrentWeekNetProfit($currentDate)
    {
        ...
        return
            Stat::make(
                ...
                Cache::remember('profitForTheWeek'.auth()->user()->id.'w_'.$currentDate->format('W'), Carbon::now()->endOfDay()->subMinute(5), function () use ($taxService, $currentDate) {
    ...
    private function calculateGrossProfit($currentDate)
    {
        ...
        return
            Stat::make(
                ...
                Cache::remember('grossProfitOfYear'.auth()->user()->id, Carbon::now()->endOfDay()->subMinute(5), function () use ($taxService, $currentDate) {
    ...
    private function calculateCurrentYearNetProfit($currentDate)
    {
        ...
        return
            Stat::make(
                ...
                Cache::remember('profitForYear'.auth()->user()->id, Carbon::now()->endOfDay()->subMinute(5), function () use ($taxService, $currentDate) {
